    ...
    public class Exercici3
    {
        public static void Main(string[] args)
        {
            ...
            const string Choice = "Quina forma vols calcular? \n 1.Quadrat \n 2.Rectangle \n 3.Cercle \n 4.Pentàgon", Square = "Digues el costat del quadrat", 
                Rectangle = "Digues el primer costat", Rectangle2 = "Digues el segon costat", Sphere="Digues el radi de la esfera", PentagonMsg= "Introdueix la base", Pentagon2="Introdueix ";
